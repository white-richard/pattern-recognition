...
if __name__ == "__main__":
    ...
    points1 = generate_2d_gas_data(num_class1, mean=mean_class1, covariance=cov_matrix, rng=rng)
    points2 = generate_2d_gas_data(num_class2, mean=mean_class2, covariance=cov_matrix, rng=rng)
